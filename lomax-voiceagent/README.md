...
Bot celý hovor vede česky, vytáhne ze zákazníka všechno, co servisní technik potřebuje, ověří to, a odešle poptávku do Make, který ji rozešle e-mailem. Telefon nediktuje — bere se z čísla volajícího.
...
| `05-testovaci-scenare.md` | 15 scénářů, které projeď před ostrým provozem |
...
**5. Test**
Projeď `05-testovaci-scenare.md`. Minimálně T1, T2, T8 a T14a než pustíš linku ven.
...
1. **Právní titul** je plnění smlouvy / oprávněný zájem — bot proto nevyžaduje mluvený souhlas. Zpracování popiš v zásadách ochrany osobních údajů, ne v hovoru.
